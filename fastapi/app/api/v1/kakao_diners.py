...
from ...schemas.kakao_diner import (
    KakaoDinerCreate,
    KakaoDinerResponse,
    KakaoDinerUpdate,
)
from ...services.kakao_diner_service import KakaoDinerService
...
@router.post("/", response_model=KakaoDinerResponse, tags=["kakao-restaurants"])
...
@router.get("/", response_model=List[KakaoDinerResponse], tags=["kakao-restaurants"])
...
@router.get(
    "/{kakao_place_id}", response_model=KakaoDinerResponse, tags=["kakao-restaurants"]
)
...
@router.delete("/{kakao_place_id}", tags=["kakao-restaurants"])
